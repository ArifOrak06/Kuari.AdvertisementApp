...
namespace Orak.AdvertisementApp.Business.Services
{
        ...
        where T : BaseEntity
    {
        ...
        public async Task<IResponse<IDto>> GetByIdAsync<IDto>(int id)
        {
            ...
            if (data == null)
            {
                return new Response<IDto>(ResponseType.NotFound, $"{id} id'sine sahip bulunamadı");
            }
        ...
        public async Task<IResponse> RemoveAsync(int id)
        {
            ...
            if (data == null)
            {
                return new Response(ResponseType.NotFound, $"{id} id'sine sahip nesne bulunamadı");
            }
        ...
        public async Task<IResponse<UpdateDto>> UpdateAsync(UpdateDto dto)
        {
            ...
            if (result.IsValid)
            {
                ...
                {
                    return new Response<UpdateDto>(ResponseType.NotFound, $"{dto.Id} id'sine sahip nesne bulunamadı");
                }
